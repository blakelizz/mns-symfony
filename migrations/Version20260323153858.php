 ...
 */
final class Version20260323153858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD updated_at DATETIME NOT NULL, ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer DROP updated_at, DROP user_id');
    }
}
